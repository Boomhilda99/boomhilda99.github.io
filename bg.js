...
function resizeCanvas() {
    ...
    canvas.height = Math.max(document.documentElement.scrollHeight, window.innerHeight) * devicePixelRatio;
    ...
    effect.particlesArray = []; // Clear and reinitialize particles for new size
    effect.init();
}
